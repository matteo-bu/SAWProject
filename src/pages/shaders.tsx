...
import { ShadersCategories, ShadersFeatures, ShadersLoaders, ShadersPerformance } from "../lists/shaders";
    ...
    const p1 = projects.filter((p)=>{
        ...
        return files.some((file)=>{
            ...
            return platforms.some((platform)=>{
                return ShadersLoaders.includes(platform);
            })
        })
    });
    const p2 = p1.filter((p)=>{
        ...
        files.forEach((file)=>{
            ...
            platforms.forEach((platform)=>{
                const pass = ShadersLoaders.includes(platform);
                if (pass) {
        ...
        <div className="container">
            ...
            <div className="horizontal">
                <div className="left">
                    ...
                    <Filter type="l" name="Loader" list={ShadersLoaders} bar={false} />
                    <Filter type="c" name="Category" list={ShadersCategories} bar={true} />
                    <Filter type="c" name="Feature" list={ShadersFeatures} bar={true} />
                    <Filter type="c" name="Performance" list={ShadersPerformance} bar={false} />
